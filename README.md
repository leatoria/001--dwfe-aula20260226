...
**Arquitetura Semântica:** Utilização de tags fundamentais do HTML5 para organizar a hierarquia da página. O objetivo foi criar uma base sólida que diferencia o que é cabeçalho, conteúdo principal e seções laterais, facilitando a leitura do código e a navegação.
